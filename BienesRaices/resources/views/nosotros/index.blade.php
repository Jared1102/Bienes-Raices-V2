...
@section('container')
    <!--
        Aqui se colocara sobre nosotros
    -->
    ...
    <main class="contenedor seccion">
        ...
        <div class="contenido-nosotros">
            <div class="imagen">
                <picture>
                    <!--<source srcset="{{Vite::asset('resources/img/nosotros.webp')}}" type="image/webp">
                    <source srcset="{{Vite::asset('resources/img/nosotros.jpg')}}" type="image/jpeg">-->
                    <img loading="lazy" src="{{Vite::asset('resources/img/nosotros.jpg')}}" alt="Sobre Nosotros">
                </picture>
            </div>
...
@section('js')
    <script src="build/js/bundle.min.js" src="{{Vite::asset('resources/js/app.js')}}"></script>
@endsection